//
//  BKLanguageServiceManager.swift
...
class HWLanguageServiceManager {
    
    private static var privateSharedInstance: HWLanguageServiceManager?
    static var sharedInstance: HWLanguageServiceManager {
        if privateSharedInstance == nil {
            privateSharedInstance = HWLanguageServiceManager()
            ...
            do{
                ...
                if let languagesArray = jsonResponse!["languages"] as? [[String : Any]] {
                    for lang in languagesArray {
                        ...
                        let rt = HWLocalizable(translations:dict)
                        do {
